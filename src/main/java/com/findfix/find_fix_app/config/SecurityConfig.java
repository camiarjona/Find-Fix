    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests(
                        request -> request
                                ...
                                .requestMatchers("/resenas/trabajo/**", "/resenas/mis-resenas", "/resenas/{id}").hasRole("CLIENTE")
                                .requestMatchers("/resenas/trabajo/**", "/resenas/titulo", "/resenas/mis-resenas", "/resenas/mis-trabajos", "/resenas/{id}").hasRole("ESPECIALISTA")
                                .requestMatchers("/resenas").hasAnyRole("CLIENTE", "ESPECIALISTA")
